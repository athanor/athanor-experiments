...
public class BINPACKING {
  ...
  public static void main(String [] args) {
    try{
      ...
      IntVar[] bins = model.intVarArray("bins", noItems, 1, noBins);
      ...
      decvarsal.addAll(Arrays.asList(bins));
      ...
      lnsvarsal.addAll(Arrays.asList(bins));
      
      // Post the global bin packing ct.
      model.binPacking(bins, weights, loads, 1).post();
